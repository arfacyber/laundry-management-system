<x-app-layout>
    ...
    <div class="bg-white rounded-lg border border-gray-200 shadow-sm max-w-2xl">
        <form action="{{ route('admin.services.store') }}" method="POST" class="p-4 sm:p-6 space-y-6">
            @csrf
            ...
            <div class="pt-4 border-t border-gray-200 flex justify-end">
                <button type="submit" class="w-full sm:w-auto bg-blue-600 text-white rounded-md shadow-sm py-2 px-6 text-sm font-medium hover:bg-blue-700 transition">Simpan Layanan</button>
            </div>
        </form>
    </div>
</x-app-layout>